...
const Technologies = () => {
    return (
        <Layout>
            <h2 id='technologies' className='font-bold text-7xl w-full text-center dark:text-ligth -mt-20 md:text-6xl md:mt-32 sm:text-3xl xs:text-2xl xs:mt-16 sm:'>Technologies</h2>
